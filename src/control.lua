...
script.on_init(nil) -- Nothing to do. Everything is initialized on demand and version aware.
...
--- @return nil
local function onInserterPlayerRotated(event)
    initSettingsCacheIfNeeded()
...
script.on_event(defines.events.on_player_rotated_entity, onInserterPlayerRotated)
