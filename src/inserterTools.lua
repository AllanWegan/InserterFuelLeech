...
--- @return uint
function getInserterMovableCountOfItemStack(stack, inserter, dstInventory)
...
function calcTicksTillInserterHandIsAtPos(inserter, destinationPos)
    local basePosX, basePosY = granularizeMapPos(inserter.position, settingsCache.vectorGranularity)
    local handPos = inserter.held_stack_position
    local handPosX, handPosY = granularizeAndRebaseMapPos(handPos, settingsCache.vectorGranularity, basePosX, basePosY)
    local destPosX, destPosY = granularizeAndRebaseMapPos(destinationPos, settingsCache.vectorGranularity, basePosX, basePosY)
    ...
    local turns, extensionDiff = calcVectorMinTurnsAndExtension(handPosX, handPosY, destPosX, destPosY)
